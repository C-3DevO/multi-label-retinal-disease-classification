...
class ClassBalancedFocalLoss(nn.Module):
    ...
    def forward(self, logits, targets):
        ...
        loss = self.class_weights * focal_term * bce_loss
...
if __name__ == "__main__":
    ...
    train_one_backbone(backbone, train_csv, val_csv, test_csv, train_image_dir, val_image_dir, test_image_dir,
                           epochs=25, batch_size=32, lr=1e-4, img_size=256, pretrained_backbone=pretrained_backbone,
                           mode="full_finetune",loss_type="class_balanced_focal",focal_gamma=1.0)
