...
def train_one_backbone(backbone, train_csv, val_csv, test_csv, train_image_dir, val_image_dir, test_image_dir, 
                       epochs=10, batch_size=32, lr=1e-4, img_size=256, save_dir="checkpoints",pretrained_backbone=None,mode="no_finetune"):
    ...
    if mode == "no_finetune":
        ...
        model.eval()
        print("Mode: NO FINE-TUNING (evaluation only)")
...
if __name__ == "__main__":
    ...
    train_one_backbone(backbone, train_csv, val_csv, test_csv, train_image_dir, val_image_dir, test_image_dir,
                           epochs=20, batch_size=32, lr=1e-5, img_size=256, pretrained_backbone=pretrained_backbone,mode="no_finetune")
